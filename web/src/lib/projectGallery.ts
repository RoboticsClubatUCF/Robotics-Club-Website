import type { ApiProjectDetail, ApiProjectImage } from './api'
import { DEFAULT_FRAMING } from './imageFraming'
 ...
 *
 * Mirrors `MAX_PROJECT_IMAGES` in `server/src/routes/projectManage.ts`, the way
