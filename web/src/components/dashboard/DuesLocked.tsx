 ...
 * these pages would 403 anyway — `requireCurrentDues` in `server/src/authz.ts`
    ...
    <>
      ...
      <FormPanel tone="accent">
        ...
        <p className="text-dim text-sm leading-[1.7] text-pretty">
          Nothing has been taken away from you — you are still on every project
          you were on, still hold the same rank, and can still see all of it.
          Running things is the part that needs a current membership.
        </p>
        <Link
          to="/dashboard/dues"
