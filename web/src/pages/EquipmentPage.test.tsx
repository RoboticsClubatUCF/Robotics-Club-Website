...
import type { ApiEquipment, ApiLoan } from '../lib/api'
import { addDays, endOfDay, startOfDay, today } from '../lib/borrowing'
import {
  bodyOf,
  stubFetch,
...
describe('EquipmentPage', () => {
  ...
  it('sends the ask against the chosen item, with the note and the dates', async () => {
    ...
    expect(await screen.findByText(/an officer has been told/i)).toBeInTheDocument()
