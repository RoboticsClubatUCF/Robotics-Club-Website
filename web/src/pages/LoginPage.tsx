...
import { ApiError, postJson, type ApiUser } from '../lib/api'
  ...
  return (
    <FormPage>
      ...
      <p className="text-dim mb-7 text-sm leading-[1.7] text-pretty">
        Your dashboard is where your dues, your projects and your subteam live.
        Sign in with the email and password you used when you created your
        account.
      </p>
      ...
      {/* There is no password reset yet, and pretending otherwise with a dead
          link would be worse than saying so. An officer can set one in Prisma
          Studio, which is the honest answer until that route exists. */}
      <div className="mt-8">
        <FormPanel>
          <p className="text-faint mb-3 font-mono text-[10px] font-medium tracking-[0.16em]">
            NO ACCOUNT, OR NO PASSWORD?
          </p>
          <p className="text-dim text-sm leading-[1.7] text-pretty">
            Joining the club is creating an account —{' '}
            <Link
              to="/join"
            ...
            . If you have forgotten your password, ask an officer in the
            Discord: there is no reset link yet, and they can set you a new one.
          </p>
        </FormPanel>
      </div>
    </FormPage>
