...
import type { ApiMyProject, Season } from '../../lib/api/api'
...
export function PastProjectsPage() {
  ...
  return (
    <>
      ...
      {/* The two states that are one panel rather than a grid of them get a
          measure, like every other page in the section that is a sentence. */}
  ...
  if (before.length === 0) {
    return (
      <div className={measureClass}>
        <FormPanel>
          <p className="text-dim text-sm leading-[1.7] text-pretty">
            Nothing here yet. Projects land here once their semester is over.
          </p>
        </FormPanel>
      </div>
    )
