 ...
 * client strips, and a verification email whose only affordance has been
...
<div style="display:none;max-height:0;overflow:hidden;mso-hide:all;opacity:0;color:transparent;">Confirm your address to finish setting up your Robotics Club account.</div>
...
<div style="font-family:${MONO};font-size:11px;font-weight:600;letter-spacing:0.2em;color:${FAINT};padding-bottom:14px;">/ CONFIRM YOUR EMAIL</div>

<h1 style="margin:0 0 14px;font-family:${SANS};font-size:26px;line-height:1.15;font-weight:700;letter-spacing:-0.02em;color:${WHITE};">One more step.</h1>

<p style="margin:0 0 26px;font-family:${SANS};font-size:15px;line-height:1.7;color:${DIM};">Confirm this address and you can finish setting up your account — your name, a password, and the Discord username we will add you under.</p>
...
<a href="${href}" style="display:inline-block;padding:15px 30px;font-family:${SANS};font-size:13px;font-weight:700;letter-spacing:0.04em;color:${ON_GOLD};text-decoration:none;">CONFIRM MY EMAIL &rarr;</a>
</td>
</tr>
</table>
...
<p style="margin:0 0 14px;font-family:${SANS};font-size:13px;line-height:1.6;color:${FAINT};">The link is good for ${expiry}. If it expires, start again from the join page and we will send a new one.</p>
<p style="margin:0 0 20px;font-family:${SANS};font-size:13px;line-height:1.6;color:${FAINT};">If you did not sign up, ignore this email — no account is created until the link is followed.</p>
<p style="margin:0;padding-top:18px;border-top:1px solid ${RULE};font-family:${MONO};font-size:10px;font-weight:500;letter-spacing:0.14em;color:${FAINT};">RCCF &middot; UNIVERSITY OF CENTRAL FLORIDA &middot; ORLANDO, FL</p>
  ...
  const text = [
    ...
    'One more step.',
    '',
    'Confirm this address and you can finish setting up your account — your',
    'name, a password, and the Discord username we will add you under.',
    '',
    link,
    '',
    `The link is good for ${expiry}. If it expires, start again from the join`,
    'page and we will send a new one.',
    '',
    'If you did not sign up, ignore this email — no account is created until',
