...
// Fallback [month (0-based), day] used when the UCF feed is unavailable
const FALLBACK_END: Record<UcfSeason, [number, number]> = {
	spring: [4, 6],   // ~May 6 (typical On-Campus Housing Closes)
	summer: [7, 7],   // ~August 7 (typical summer end)
	fall:   [11, 31]  // December 31
};

const FALLBACK_START: Record<UcfSeason, [number, number]> = {
	spring: [0, 12],  // January 12
	summer: [4, 18],  // May 18
	fall:   [7, 24]   // August 24
};
