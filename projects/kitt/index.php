...
$keywords = "UCF robotics club, University of Central Florida, UCF, robotics club, robotics club,
                               ...
                               Central Florida, central florida, robotics club, kitt, autonomous boat, roboboat, autonomous roboboat";
$headerGen = new Header("Alexandra French", "September 10, 2020", "Alexandra French", "November 12, 2020");
$headerGen->generateComment();
$headerGen->generateCommon("Robotics Club Project: Kitt", $pageDescription, $keywords, "https://robotics.ucf.edu/projects/kitt/index");
$headerGen->generateCSS();
$headerGen->genProjectSEO("https://robotics.ucf.edu/projects/kitt/index", "Robotics Club Project: Kitt", $pageDescription, "August 2017");
$headerGen->endHeader();
...
// page content
include_once('assets/templates/kitt.html');
