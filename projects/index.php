...
$headerGen->generateCommon("Robotics Club Projects", $pageDescription, $keywords, "https://robotics.ucf.edu/projects/index");
$headerGen->generateCSS();
$headerGen->genWebsiteSEO("https://robotics.ucf.edu/projects/index", "Robotics Club Projects", $pageDescription, "https://robotics.ucf.edu/projects/assets/imgs/bowser.jpg");
$headerGen->endHeader();
